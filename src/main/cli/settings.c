...
// PG_MIXER_CONFIG
    ...
    { "dynamic_rpm_limit",          VAR_INT8   |  MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_MIXER_CONFIG, offsetof(mixerConfig_t, dynamic_rpm_limit) },
    ...
    { "rpm_limit_value",            VAR_UINT32 |  MASTER_VALUE,  .config.minmaxUnsigned = { 1, UINT16_MAX }, PG_MIXER_CONFIG, offsetof(mixerConfig_t, rpm_limit_value) },
    { "min_dynamic_rpm_limit_value",VAR_UINT32 |  MASTER_VALUE,  .config.minmaxUnsigned = { 1, UINT16_MAX }, PG_MIXER_CONFIG, offsetof(mixerConfig_t, min_dynamic_rpm_limit_value) },
    { "max_dynamic_rpm_limit_value",VAR_UINT32 |  MASTER_VALUE,  .config.minmaxUnsigned = { 1, UINT16_MAX }, PG_MIXER_CONFIG, offsetof(mixerConfig_t, max_dynamic_rpm_limit_value) },
#endif
...
// PG_OSD_CONFIG
    ...
    { "osd_logo_on_arming_duration",VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 50 }, PG_OSD_CONFIG, offsetof(osdConfig_t, logo_on_arming_duration) },
